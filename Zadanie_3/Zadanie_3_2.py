...
def main():
    ...
    t0 = time.time(); cl_man = manual_clahe(gray, 2.0, (8, 8)); t_cl_man = time.time() - t0
    t0 = time.time(); cl_cv  = opencv_clahe_gray(gray, 2.0, (8, 8)); t_cl_cv  = time.time() - t0
